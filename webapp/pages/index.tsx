...
const CLIENT_ID = 'Iv1.77f932747a4c6f4a'
...
export default function Home() {
  ...
  function selectRepo(repo: any) {
    ...
    session.process?.start({
      cmd: `cd /code && ts-node -T ./tailwind.ts "${clone_url}" "${accessToken}" "${url}"`,
      onStdout: (o => console.log(o.line)),
      onStderr: (e => console.error(e.line))
    })
